...
/**
 * Note: This class is not meant for unit-testing since it uses system features at low level and
 * that it uses 'System' standard input stream methods to read text from user. Also unit-tests in CI
 * environments don't have console input for user to type in text. But the usage below demonstrates
