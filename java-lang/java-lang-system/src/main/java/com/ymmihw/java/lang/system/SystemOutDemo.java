 ...
 * that it uses 'System' standard output stream methods to show output on screen. Also unit-tests in
 * CI environments don't have console output for user to see messages. But the usage below
