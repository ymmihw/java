...
public class DaylightSavingTimeJavaTimeExamplesUnitTest {
  ...
  @Test
  public void givenItalianTimeZone_WhenDSTHappens_ThenCorrectlyShiftTimeZone()
    ...
    Long deltaBetweenDatesInMinutes =
        ChronoUnit.MINUTES.between(zonedDateTimeBeforeDST, zonedDateTimeAfterDST);
  ...
  public void whenCounting_ThenPrintDifferencesBetweenAPIs() {
    System.out
        .println("Total java.time.ZoneId      count : " + ZoneId.getAvailableZoneIds().size());
